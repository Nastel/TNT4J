...
interface JSONLabels {
	...
	String JSON_START_TIME_USEC_FIELD = "start-time-usec"; // doc defines "start-time-used"
	String JSON_END_TIME_USEC_FIELD = "end-time-usec"; // doc defines "end-time-used"
	String JSON_ELAPSED_TIME_USEC_FIELD = "elapsed-time-usec";
	String JSON_WAIT_TIME_USEC_FIELD = "wait-time-usec"; // doc defines "wait-time-used"
	String JSON_MSG_AGE_USEC_FIELD = "msg-age-usec"; // doc defines "msg-age"
