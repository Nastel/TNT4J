...
public class ContextRef {
	 ...
	 * 
	 * @param obj
	 *            for which to create a reference
	 */
	...
	/**
	 * Create a context reference for a given object and a specific {@link UUIDFactory} which is used to generate
	 * correlation id for this object.
	 * 
	 * @param obj
	 *            for which to create a reference
	 * @param uuidFactory
	 *            used to generate correlation ids
	 */
	...
	/**
	 * Create a context reference for a given object with a given unique id.
	 * 
	 * @param obj
	 *            for which to create a reference
	 * @param cid
	 *            correlation to be associated with this context reference
	 */
	...
	/**
	 * Obtain object id (not its correlation id). Use {@link #cid()} to obtain correlation id associated with this
	 * object.
	 * 
	...
	/**
	 * Calculate elapsed nanoseconds from now to when this context reference was created.
	 * 
	 ...
	 * 
	 * @param obj
	 *            for which to generate a reference id
