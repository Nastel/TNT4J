...
/**
 * This class provides a static way to get default event sink factory. Default event sink factory is set to
 * {@link com.jkoolcloud.tnt4j.sink.impl.slf4j.SLF4JEventSinkFactory}. Developers may initialize default event sink
 * factory at runtime via code as follows:
 * 
 * <pre>
 * {@code
 ...
 * </pre>
 * 
 * Another way to initialize to via a java property {@code tnt4j.default.event.factory} java property and setting to the
 * name of the class that implements {@link EventSinkFactory} interface. Example:
 * 
 * <pre>
 * {@code
 ...
 * </pre>
 * 
 * Below is an example of how to obtain an event sink based on a default event sink factory. Use this method for all
 * default logging.
 * 
 * <pre>
 * {@code
...
public class DefaultEventSinkFactory {
	public static final String DEFAULT_EVENT_FACTORY_KEY = "tnt4j.default.event.factory";
	private static final String DEFAULT_FACTORY_CLASS = "com.jkoolcloud.tnt4j.sink.impl.jul.JULEventSinkFactory";
	...
	/**
	 * Initialize default even sink factory based on given environment. Default event sink factory can be specified
	 * using {@code tnt4j.default.event.factory} java property and setting to the name of the class that implements
	 * {@link EventSinkFactory} interface. The given event sink factory class must provide a default public constructor
	 * with no arguments.
	 *
	 * @see EventSinkFactory
	 */
	...
	/**
	 * Create an instance of {@link EventSinkFactory} based on a given class name. The class must provide a default
	 * public constructor with no arguments.
	 *
	 * @param className
	 *            class name that implements {@link EventSinkFactory} interface.
	 ...
	 *
	 * @param factory
	 *            event sink factory to use as default implementation
